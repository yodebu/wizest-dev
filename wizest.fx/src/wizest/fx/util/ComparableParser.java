...
public class ComparableParser extends AbstractParser
{
    ...
    /**
     * @param ps Parser[]
     * @param comparator Comparator 서로 다른 parser에서 parsing된 marker를 비교 한다. (최종 정렬되었을 때 첫번째 mark가 선택됨)
     * @param minStringLength int
     */
    public ComparableParser(Parser[] ps, Comparator comparator, int minStringLength)
    {
        this.ps = ps;
        psLen = ps.length;
