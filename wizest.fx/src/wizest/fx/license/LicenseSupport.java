...
public class LicenseSupport implements Serializable{
    ...
    public LicenseSupport(String product, String version,
                              String licenseFrom, String licenseTo,
                              Date beginDate, Date endDate, String licenseDescription,
                              Map values
                              ) {
