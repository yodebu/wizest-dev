 ...
 * 
 */
public class ATAttributeParser extends AbstractParser implements AttributeParser {
    private static final String TAG_OPEN = ATTagParser.TAG_OPEN;
    private static final String TAG_CLOSE = ATTagParser.TAG_CLOSE;
    private static final char NAME_SEPARATOR = ATTagNameParser.NAME_SEPARATOR; // ','
