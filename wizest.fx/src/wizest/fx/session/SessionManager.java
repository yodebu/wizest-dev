...
public abstract class SessionManager
{
     ...
     * session을 생성하여 리턴한다.
     *
     * @param sessionId 생성할 session의 id
     * @return
     */
    ...
    /**
     * @param context session manager의 context로 지정할 것
     */
    ...
    /**
     * @param interval session의 default timeout (초)
     */
    ...
    /**
     * @param checkInterval timeout된 session들을 정리하는 thread의 check 주기 (초)
     */
     ...
     *
     * @param sessionId 가져오고자 하는 sessionId
     * @return
     */
     ...
     *
     * @param sessionId 가져오고자 하는 sessionId
     * @param create sessionId에 해당하는 session이 없을 경우 생성 여부
     * @return
     */
     ...
     *
     * @param session 추가하고자 하는 session
     */
     ...
     *
     * @param session 제거 하고자 하는 session
     */
