 ...
 * @author wizest
 */
public class BAttributeParser extends AbstractParser implements AttributeParser {
    final static int OPEN_SIZE = BTagParser.TAG_OPEN.length();
    final static int CLOSE_SIZE = BTagParser.TAG_CLOSE.length();
