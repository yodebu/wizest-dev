...
{
    /**
     * parsing하고자 하는 string을 설정한다.
     * parsingPoint는 reset된다.
     * @param text
     */
     ...
     * parsing하고자 하는 string을 설정한다.
     * parsingPoint는 reset된다.
     * @param mark mark.getParsedString()이 parsing 하려는 string으로 설정된다.
     */
     ...
     * mark가 null일 경우 text의 마지막 위치+1을 가르킨다.
     * @param mark mark의 endIndex+1 를 다음 parsing의 시작 위치로 한다.
     */
