...
public class InstanceCreator {
     ...
     * <br>* inner configured object를 허용한다. -><b>&lt;value/&gt; 안에 &lt;configured-object/&gt; 가 들어가도 괜찮다.!! </b> <br>
     ...
     * @throws InstanceCreationException
     */
    private static HashMap getWriteMethodMapTable(Class clazz) throws InstanceCreationException {
        try {
            // property 의 set method 를 table화 시킴
    ...
    private static Hashtable cachedMethodMapTable = new Hashtable(); // write method 를 cache해서 introspection을 덜 하도록..
     ...
     * 
     * 주의1: 같은 property에 해당하는 names와 values는 index가 서로 일치해야한다. 
     * 주의2: property setter method 찾지 못할 경우 아무런 메세지 없이 skip한다.
     * 
     * @param beanObject
     * @param propertyNames
     * @param propertyValues
    ...
    public static Object setPropertyValues(Object beanObject, String[] propertyNames, Object[] propertyValues) throws InstanceCreationException {
        try {
            ...
            for (int i = 0; i < names.length; ++i) {
                ...
                //                    throw new InstanceCreationException( "could not find setter method of property name:" + name );
                if (setter == null) {
                    //                    System.err.println("could not find setter method of property name:" + name);
                    continue;
                }
                //                try
                //                {
                ...
                try {
                    ...
                    //                          throw new InstanceCreationException("primitive type do not allow null.");
